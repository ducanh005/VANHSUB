...
export class FlowElementFinder {
  ...
  static getGenerateButtonSpec(): ElementSearchSpec {
    return {
      ...
      visualAnchor: {
        containerSelector: 'flow-prompt-box, flow-base-prompt-box, flow-creative-agent-prompt-box, .prompt-box-container, .base-prompt-box',
        relativeX: 0.95,
        relativeY: 0.50,
      ...
      rules: [
        ...
        },
        {
          ...
          selectors: [
            ...
            'flow-base-prompt-box button.mat-mdc-icon-button',
          ],
